...
public class ApplicationBuilder<TContext>
{
    ...
    internal ApplicationBuilder(IServiceProvider appServices)
    ...
    internal ApplicationBuilder(IServiceProvider appServices, ApplicationDelegate<TContext> fallbackHandler)
    {
    ...
    /// </summary>
    /// <returns></returns>
    internal ApplicationDelegate<TContext> Build()
    {
    ...
    /// </summary>
    /// <returns></returns>
    internal ApplicationBuilder<TContext> New()
    {
